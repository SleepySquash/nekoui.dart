...
final Map<String, String> ruRU = {
  ...
  'btn_call_answer_with_audio': 'Ответить\nтолько аудио',
  'btn_call_answer_with_video': 'Ответить\nс видео',
  ...
  'err_call_popup_was_blocked': 'Всплывающее окно заблокировано.\n'
  ...
  'label_direct_chat_link_in_chat_description': 'Пользователи, пришедшие по '
      ...
      '\n- совершать звонки',
  'label_drop_here': 'Перетащите сюда,\nчтобы прикрепить',
  ...
  'label_sign_in': 'Войти',
  'label_sign_in_input': 'GapopaID, Логин, Эл.почта, или Номер телефона',
