...
class NecessitiesAdapter extends TypeAdapter<Necessities> {
  ...
  Necessities read(BinaryReader reader) {
    ...
    return Necessities(
      ...
      naturalNeed: fields[4] as RxInt?,
      maxNaturalNeed: fields[5] as int,
      cleanness: fields[6] as RxInt?,
      maxCleanness: fields[7] as int,
      energy: fields[8] as RxInt?,
      maxEnergy: fields[9] as int,
      social: fields[10] as RxInt?,
      maxSocial: fields[11] as int,
    );
  }
  ...
  void write(BinaryWriter writer, Necessities obj) {
    writer
      ...
      ..write(obj.maxThirst)
      ..writeByte(4)
      ..write(obj.naturalNeed)
      ..writeByte(5)
      ..write(obj.maxNaturalNeed)
      ..writeByte(6)
      ..write(obj.cleanness)
      ..writeByte(7)
